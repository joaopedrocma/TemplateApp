...
public class Pensionista {
	...
	public Pensionista(Long matricula, String nome, String cpf, Long codrubrica, Long valrubrica) {
		super();
	...
	public String toString() {
		return "Pensionista [matricula=" + matricula + ", nome=" + nome + ", cpf=" + cpf + ", codrubrica=" + codrubrica
